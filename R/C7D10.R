#' @name C7D10
#' @title A data generating model with Seven clusters 
#' @description  Seven clusters in multiple dimensions having unequal within cluster variations. All the clusters are generated from Gaussain distributions.  
#' @usage C7D10(n)
...
#' }
#' @details The data set has ten dimensions.
